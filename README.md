...
Las firmas del vault (`id.dotrino.com`) prueban **quién** firmó y **qué**, pero
...
`signer.dotrino.com` es la autoridad **canónica**: las apps pinean su pubkey y
...
const res = await fetch('https://signer.dotrino.com/seal', {
  method: 'POST',

// dotrino-signer — Autoridad de sello de tiempo (TSA) del ecosistema
// Dotrino. Es un TERCERO de confianza: firma con SU clave un par
...
//
// Pensado para desplegarse en https://signer.dotrino.com y ser pineado por las
...
function setCors (res) {
  ...
  // del ecosistema (mundial.dotrino.com, etc.) pueda pedirlos desde el navegador.
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'GET' && (url === '/' || url === '/health')) {
    return sendJson(res, 200, { ok: true, service: 'dotrino-signer', ...pubkeyPayload() });
  }
...
server.listen(PORT, () => {
  console.log(`[signer] dotrino-signer escuchando en :${PORT}`);
